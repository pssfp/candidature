...
<html lang="en">
    ...
    <body>
		...
		<div id="content">
			...
			<p style="margin-left:250px;font-size:14px" ><strong><?php echo $titre; ?></strong><p>
			<table border="0" cellpadding="4" cellspacing="0"  style="margin-left:50px; font-size:12px;">
				<tr>
				    <th>N0</th>
				    <th>Ordre</th>
				    <th>Nom Prenom</th>
				...
				<tr><td colspan="9">Nombres d'inscrit: <strong><?php echo count($candidats);?></strong></td></tr>
			</table>
		</div>
    </body>
</html>